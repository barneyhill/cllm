    ...
    for claim in claims:
        ...
        claim_list.append(
            DBClaim(
                ...
                source=claim.source,
                source_type=json.dumps(claim.source_type),
        ...
        for row in concordance:
            ...
            comparison_list.append(
                DBComparison(
                    ...
                    openeval_evaluation_type=row.openeval_evaluation_type,
                    peer_evaluation_type=row.peer_evaluation_type,
                    openeval_result_type=row.openeval_result_type,
                    peer_result_type=row.peer_result_type,
